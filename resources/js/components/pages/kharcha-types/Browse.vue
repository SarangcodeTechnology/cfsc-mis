                            ...
                            <v-row>
                                <v-col cols="3">
                                    <div class="d-flex align-content-center">
                                        <h5 class="mb-0 align-self-center">खर्च बर्गिकरण प्रकारहरु</h5>
...
export default {
    ...
    methods: {
        getDataFromApi() {
            ...
            this.$store.dispatch("getKharchaTypes", {}).then(function (response) {
        ...
        editData(item) {
            this.$store.dispatch("setKharchaTypesEditData", item)
        },
        confirm(item) {
            const tempthis = this;
        ...
        deleteData(item) {
            let tempthis = this;
            this.$store.dispatch("deleteKharchaTypes", item).then(function (response) {
