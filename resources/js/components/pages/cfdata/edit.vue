    ...
    >
        ...
        >
            <v-toolbar flat>
                ...
                <v-spacer></v-spacer>
                <v-btn class="ma-2" hint="E.g. : Save" depressed dark  color="green darken-1">
            ...
            <v-card-text>
                    ...
                    <span>सामुदायिक वन विवरण फारममा तपाइहरुलाइ स्वागत छ । कृपया तलकाे फारम मार्फत आफ्नाे विवरण
                                सूचना
                                प्रणालीमा सुनिश्चित गर्नुहाेस् ।</span>
                        <v-divider></v-divider>
...
export default {
    ...
    methods: {},
    computed: {
        ...mapState({provinces: state => state.webservice.resources.provinces}),
        districts: function () {
            const tempthis = this;
            let data = [];
