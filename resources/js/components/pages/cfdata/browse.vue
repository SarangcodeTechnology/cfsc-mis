            ...
            <v-container>
                <v-row>
                    <v-col>
                        ...
                        <v-row>
                            <v-col>
                                <v-text-field v-model="filterData.areaHa.from"
                                              chips
                            ...
                            <v-col>
                                <v-text-field v-model="filterData.areaHa.to"
                                              chips
...
<!--                        <v-row>-->
<!--                            <v-col>-->
<!--                                <v-text-field v-model="filterData.hh.from"-->
<!--                                              chips-->
...
<!--                            </v-col>-->
<!--                            <v-col>-->
<!--                                <v-text-field v-model="filterData.hh.to"-->
<!--                                              chips-->
...
<!--                        <v-row>-->
<!--                            <v-col>-->
<!--                                <v-text-field v-model="filterData.totalPopulation.from"-->
<!--                                              chips-->
...
<!--                            </v-col>-->
<!--                            <v-col>-->
<!--                                <v-text-field v-model="filterData.totalPopulation.to"-->
<!--                                              chips-->
...
<!--                        <v-row>-->
<!--                            <v-col>-->
<!--                                <v-text-field v-model="filterData.menPopulation.from"-->
<!--                                              chips-->
...
<!--                            </v-col>-->
<!--                            <v-col>-->
<!--                                <v-text-field v-model="filterData.menPopulation.to"-->
<!--                                              chips-->
<!--                                              dense-->
<!--                                              label="To"-->
<!--                                              outlined-->
...
<!--                        <v-row>-->
<!--                            <v-col>-->
<!--                                <v-text-field v-model="filterData.womenPopulation.from"-->
<!--                                              chips-->
...
<!--                            </v-col>-->
<!--                            <v-col>-->
<!--                                <v-text-field v-model="filterData.womenPopulation.to"-->
<!--                                              chips-->
...
<!--                        <v-row>-->
<!--                            <v-col>-->
<!--                                <v-text-field v-model="filterData.numberOfPersonInCommittee.from"-->
<!--                                              chips-->
<!--                                              dense-->
<!--                                              label="From"-->
<!--                                              number-->
...
<!--                            </v-col>-->
<!--                            <v-col>-->
<!--                                <v-text-field v-model="filterData.numberOfPersonInCommittee.to"-->
<!--                                              chips-->
...
<!--                        <v-row>-->
<!--                            <v-col>-->
<!--                                <v-text-field v-model="filterData.menInCommittee.from"-->
<!--                                              chips-->
...
<!--                            </v-col>-->
<!--                            <v-col>-->
<!--                                <v-text-field v-model="filterData.menInCommittee.to"-->
<!--                                              chips-->
...
<!--                        <v-row>-->
<!--                            <v-col>-->
<!--                                <v-text-field v-model="filterData.womenInCommittee.from"-->
<!--                                              chips-->
...
<!--                            </v-col>-->
<!--                            <v-col>-->
<!--                                <v-text-field v-model="filterData.womenInCommittee.to"-->
<!--                                              chips-->
    ...
    data() {
        return {
            ...
            headers: [
                ...
                {text: "वनको प्रकार", value: "cfug_type.name"},
                {text: "डिभिजन", value: "division.name"},
                {text: "सब डिभिजन", value: "sub_division.name"},
    ...
    methods: {
        ...
        goToEditPage() {
            this.$store.dispatch("setCfEditData", {
                ...
                scientific_forest_area_ha: null,
