...
export default {
    data() {
        return {
            ...
            headers: [
                ...
                {text: "आम्दानी प्रकार", value: "income_type.title"},
                {text: "रकम (रु)", value: "income"},
    ...
    computed: {
        ...mapState({income: (state) => state.webservice.income}),
    },
    methods: {
        getDataFromApi() {
            const tempthis = this;
            ...
            this.$store.dispatch("getIncome", {}).then(function (response) {
