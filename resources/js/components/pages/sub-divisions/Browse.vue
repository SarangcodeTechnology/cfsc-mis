        ...
        <v-row>
            <v-col cols="auto">
                <div class="d-flex align-content-center">
                    <h5 class="mb-0 align-self-center">सब-डिभिजन</h5>
                            ...
                            <v-row>
                                <v-col cols="12">
                                    <v-text-field
                                        ...
                                        label="सब-डिभिजनको नाम"
                                        outlined
                                        placeholder="सब-डिभिजनको नाम राख्नुहाेस् ।"
                                        :rules="[(v) => !!v || 'सब-डिभिजनको नाम राख्न अनिवार्य छ']"
                                    ></v-text-field>
                                </v-col>
                                <v-col cols="6">
                                    <v-autocomplete
...
export default {
    data() {
        return {
            headers: [
                ...
                {text: "सब-डिभिजनको नाम", value: "name"},
            ],
            loading: false,
            page: 1,
            totalItems: 0,
    ...
    methods: {
        ...
        deleteData(item) {
            let tempthis = this;
            this.$store.dispatch("deleteData", {id: item.id, model: 'SubDivision'}).then(function (response) {
